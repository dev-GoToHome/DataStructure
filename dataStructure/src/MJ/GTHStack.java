...
class StringNode {
    ...
    StringNode(String value, StringNode next) {
        setDefault(value, next);
    }

    private void setDefault(String value, StringNode next) {
        this.value = value;
        this.next = next;
    }
}

public class GTHStack {
